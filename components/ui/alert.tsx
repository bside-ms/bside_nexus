...
function Alert({ className, variant, ...props }: React.ComponentProps<'div'> & VariantProps<typeof alertVariants>): ReactElement {
...
function AlertDescription({ className, ...props }: React.ComponentProps<'div'>): ReactElement {
    return (
        <div
