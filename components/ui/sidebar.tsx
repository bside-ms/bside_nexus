    ...
    ({ className, onClick, ...props }, ref) => {
        ...
        return (
            ...
            >
                ...
                <span className="xl:hidden">Menü</span>
            </Button>
        );
    },
);
    ...
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Comp
                ...
                className={cn(
                    'duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-sm font-medium text-sidebar-foreground/70 outline-hidden ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
const SidebarMenuBadge = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
    <div
        ...
        className={cn(
            'absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 font-medium tabular-nums text-sidebar-foreground select-none pointer-events-none',
